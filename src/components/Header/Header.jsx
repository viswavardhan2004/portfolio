...
const Header = () => {
  ...
  return (
    <header className={`st-site-header st-style1 ${sticky ? 'st-sticky-active' : ''}`}>
          ...
          <div className="st-main-header-in">
            ...
            <div className="st-main-header-right">
              <div className="st-nav">
                <ul className={`st-nav-list st-onepage-nav ${mobileToggle ? 'active' : ''}`}>
                  ...
                  <li><ScrollLink to="portfolio" spy={true} smooth={true} offset={-80} duration={500} onClick={() => setMobileToggle(false)}>Projects</ScrollLink></li>
                ...
                <div className="sp-phone">
                  ...
                  <div className="sp-phone-no">+91 9121345262</div>
                </div>
              </div>
            </div>
          </div>
