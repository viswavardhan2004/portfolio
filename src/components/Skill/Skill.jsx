...
const Skill = ({ data }) => {
  const { technicalSkills, nonTechnicalSkills } = data;
  return (
        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="st-skill-wrap">
              ...
              >
                <h2 className="st-skill-title">{technicalSkills.title}</h2>
                <div className="st-skill-subtitle">{technicalSkills.text}</div>
              </div>
            </div>
          </div>
          <div className="col-lg-6">
            ...
            <div className="st-progressbar-wrap">
              {technicalSkills.skills.map((element, index) => (
                <div
          ...
          <div className="col-lg-6">
            <div className="st-skill-wrap">
              <div
                ...
                data-aos-duration="800"
              >
                <h2 className="st-skill-title">{nonTechnicalSkills.title}</h2>
                <div className="st-skill-subtitle">{nonTechnicalSkills.text}</div>
              </div>
            </div>
          </div>
          <div className="col-lg-6">
            <div className="st-height-b0 st-height-lg-b30"></div>
            <div className="st-progressbar-wrap">
              {nonTechnicalSkills.skills.map((element, index) => (
                <div
                  className="st-single-progressbar"
                  key={index}
                  data-aos={element.effect}
